...
def go(args):
    ...
    sk_pipe.fit(X_train, y_train) # YOUR CODE HERE
    ######################################
    ...
    mlflow.sklearn.save_model(sk_pipe, "random_forest_dir") # YOUR CODE HERE
    ######################################
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Trained Random Forest model for price prediction",
        metadata=rf_config
    )
